...
class DisplayAfriqueVideo extends Component {
  ...
  getVideo = async () => {
    let pathApi = process.env.REACT_APP_PATH_API_DEV + '/popularity/get_popularity_liked_general_video_travel_information_continent_afrique'
    if (process.env.NODE_ENV === 'production') {
      pathApi = process.env.REACT_APP_PATH_API_PROD + '/popularity/get_popularity_liked_general_video_travel_information_continent_afrique'
    }
